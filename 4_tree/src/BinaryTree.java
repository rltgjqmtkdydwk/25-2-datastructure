...
public class BinaryTree<Key extends Comparable<Key>> {
    ...
    public void preorder(Node<Key> n) { // 전위 순회
        if (n != null) {
    ...
    public void inorder(Node<Key> n) { // 중위 순회
        if (n != null) {
    ...
    public void postorder(Node<Key> n) { // 후위 순회
        if (n != null) {
    ...
    public void levelorder(Node<Key> root) { // 레벨 순회
